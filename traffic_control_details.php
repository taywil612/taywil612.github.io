...
<head>
  ...
  <title>Taylor's Portfolio - Traffic Control System</title>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="assets/img/portfolio/Intersection.png" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="assets/img/portfolio/8cars.png" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="assets/img/portfolio/10cars.png" alt="">
                </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                <li><strong>Category</strong>: Program</li>
                <li><strong>Project date</strong>: November 2022</li>
                <li><strong>Project URL</strong>: <a href="https://github.com/taywil612/TaylorPortfolio/tree/main/OperatingSystems">Traffic Control System</a></li>
              </ul>
            </div>
            <div class="portfolio-description">
              <h2>Details</h2>
              <p>
                This project is made to be a reflection of a traffic control system.<br> 
                <br>
                ...
                This was implemented in the project through semaphores and pthreads where each car, which can come from any direction, has its own thread.<br>
                <br>
                ...
                go through the intersection and see if they perform the actions required within a reasonable time frame (as seen in outputs screenshots). <br>
                <br>
              ...
              <div class="resume-item">
                <a href="file/Project 3 CIS 450 Doc.pdf" target="_blank">Click here to read more of this project's information!</a>
              </div>
            </div>
          </div>
